    ...
    methods
        function obj = ast_min(A, B, d, flag)
            switch nargin
                ...
                case 2
                    val = min(value(A), value(B));
                    num = min(numval(A), numval(B));
                    sz  = size(num);
                ...
                case 3
                    val = min(value(A), value(B), d);
                    num = min(numval(A), numval(B), d);
                    sz  = size(num);
                    red = all(isa_reducible(A) & isa_reducible(B)) & true(sz);
                    t0_A = get_t0(A);
                    t0_B = get_t0(B);
                ...
                case 4
                    val = min(value(A), value(B), d, flag);
                    num = min(numval(A), numval(B), d, flag);
                    sz  = size(num);
                    red = all(isa_reducible(A) & isa_reducible(B)) & true(sz);
                    t0_A = get_t0(A);
                    t0_B = get_t0(B);
