function [dx,c]=MVEM2(w_ice,p_im,p_em,w_tc,u_f,u_wg,P_gen,param)
...
% lambda=dot_m_ci./(param.AFs*dot_m_f); %Becomes infinite for zero fuel-flow
phi=(param.AFs*dot_m_f)./dot_m_ci;

%cylinder_Torque
a=(param.eta_ig_isl(2)-param.eta_ig_isl(1))./(-param.eta_ig_isl(3).^2);
b=-param.eta_ig_isl(3)*2*a;
