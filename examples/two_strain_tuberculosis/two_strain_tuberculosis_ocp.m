yops Times: t t0 tf
yops State: x size: [6,1] nominal: [1e4,1e4,1e4,1e3,1e3,1e3]
...
[beta1,beta2,mu,d1,d2,k1,k2,r1,r2,p,q,Npop,betas,lam] = tbc_param();
...
function [beta1,beta2,mu,d1,d2,k1,k2,r1,r2,p,q,Npop,betas,lam]=tbc_param()
beta1 = 13;
beta2 = 13;
mu = 0.0143;
d1 = 0;
