classdef ast_linspace < yop.ast_expression
    ...
    methods
        ...
        function [topsort, visited, n_elem] = topological_sort(obj, topsort, visited, n_elem)
            ...
            % Visit child
            [topsort, visited, n_elem] = topological_sort(obj.x1, topsort, visited, n_elem);
            [topsort, visited, n_elem] = topological_sort(obj.x2, topsort, visited, n_elem);
            [topsort, visited, n_elem] = topological_sort(obj.n, topsort, visited, n_elem);
